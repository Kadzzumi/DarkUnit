...
UExecCals_EnemyDamage::UExecCals_EnemyDamage()
{
	//Target
...
void UExecCals_EnemyDamage::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams,
